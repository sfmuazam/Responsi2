...
export class CatatanPage {
  ...
  getCatatan(id: any) {
    this._apiService.lihat(id, '/tampilCatatan.php?id_user=').subscribe({
      next: (res: any) => {
    ...
    this.alertController.create({
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: (data: any) => {
            //jika tekan yakin
            this._apiService.hapus(id, '/hapusCatatan.php?id_catatan=').subscribe({
              next: (res: any) => {
                console.log('sukses', res);
                this.page = 0;
                this.perPage = 10;
